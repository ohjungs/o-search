...
# 333개/1000자)이 1,000자당 **0.95ms** 다(2026-09-05 실측 0.939~0.970 · 낮은 쪽으로
# 안 내린다). 한 요청이 문서 PASSAGE_LIMIT(10)건을 재파싱하니 35,000자면
# **332.5ms, 500ms 예산의 67%** 다 (10만자는 950ms 로 예산을 넘어 안 쓴다 —
...
# 재파싱이 예산의 67% 를 먹는다는 사실이 그대로 드러난다. **그 몫을 다시 긋는 것은
