...
note: 계획 101 `e2e-fd-leak` 4/4 완료 · e2e 통과. **앞 밤이 「탐색 막힘」으로 닫은 자리에서 근거가 나왔다** — 여덟 출처는 이번에도 0건이었지만, digest `[4]` 가 반복 586 에 「단위 쪽은 닫혔다」로 갱신돼 있던 그 항목의 **e2e 절반을 아무도 안 쟀다는 것**이 근거였다. 30건 → 0건 · 22/22 · 단위 788 OK
---
